...
namespace BusinessLogics
{
    public class BLLStageAdmin
    {
        ...
        public static void Insert(Stage_N stage_n)
        {
            ...
            param[0] = new SqlParameter("@stage_m_id", SqlDbType.NVarChar, 15);
            param[0].Direction = ParameterDirection.Output;
            param[1] = new SqlParameter("@stage_m_name", stage_n.Stage_n_name);
            param[2] = new SqlParameter("@stage_m_desc", stage_n.Stage_n_desc);
            param[3] = new SqlParameter("@stage_m_disease_id", stage_n.Stage_n_disease_id);
        ...
        public static void Insert(Stage_T stage_t)
        {
            ...
            param[0] = new SqlParameter("@stage_m_id", SqlDbType.NVarChar, 15);
            param[0].Direction = ParameterDirection.Output;
            param[1] = new SqlParameter("@stage_m_name", stage_t.Stage_t_name);
            param[2] = new SqlParameter("@stage_m_desc", stage_t.Stage_t_desc);
            param[3] = new SqlParameter("@stage_m_disease_id", stage_t.Stage_t_disease_id);
